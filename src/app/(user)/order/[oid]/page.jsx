...
export const metadata = {
  title: 'Order Confirmation | MATRiX Mall - Your Order Has Been Successfully Placed',
  description:
    'Congratulations! Your order has been successfully placed on MATRiX Mall. Thank you for choosing us for your shopping needs. Expect fast processing and delivery. Stay tuned for updates on your order status. Shop more with MATRiX Mall!',
  applicationName: 'MATRiX Mall',
  authors: 'MATRiX Mall',
  keywords:
    'order confirmation, MATRiX Mall, order placed, successful order, order processing, order delivery, order status, order updates, fast delivery, shopping confirmation, shopping success, shopping updates, online shopping'
};
